...
local Themes = {
	...
	Sakura = {
		...
		AcrylicMain = Color3.fromRGB(220, 185, 198),
		AcrylicBorder = Color3.fromRGB(255, 248, 250),
		AcrylicGradient = ColorSequence.new{
			ColorSequenceKeypoint.new(0, Color3.fromRGB(232, 198, 209)),
			ColorSequenceKeypoint.new(0.25, Color3.fromRGB(226, 191, 202)),
			ColorSequenceKeypoint.new(0.50, Color3.fromRGB(218, 182, 194)),
			ColorSequenceKeypoint.new(0.75, Color3.fromRGB(208, 170, 184)),
			ColorSequenceKeypoint.new(1, Color3.fromRGB(196, 155, 171)),
		},
		AcrylicNoise = 0.92,
	
		TitleBarLine = Color3.fromRGB(255, 248, 250),
		Tab = Color3.fromRGB(90, 65, 75),
	
		Element = Color3.fromRGB(232, 198, 209),
		ElementBorder = Color3.fromRGB(255, 250, 252),
		...
		DropdownFrame = Color3.fromRGB(232, 198, 209),
		DropdownHolder = Color3.fromRGB(224, 188, 200),
		DropdownBorder = Color3.fromRGB(255, 250, 252),
		DropdownOption = Color3.fromRGB(90, 65, 75),
	
		Keybind = Color3.fromRGB(228, 193, 205),
	
		Input = Color3.fromRGB(224, 188, 200),
		InputFocused = Color3.fromRGB(236, 205, 215),
		InputIndicator = Color3.fromRGB(252, 209, 215),
		InputIndicatorFocus = Color3.fromRGB(255, 255, 255),
	
		Dialog = Color3.fromRGB(232, 198, 209),
		DialogHolder = Color3.fromRGB(224, 188, 200),
		DialogHolderLine = Color3.fromRGB(255, 250, 252),
		DialogButton = Color3.fromRGB(232, 198, 209),
		DialogButtonBorder = Color3.fromRGB(255, 250, 252),
		DialogBorder = Color3.fromRGB(255, 250, 252),
		DialogInput = Color3.fromRGB(224, 188, 200),
		DialogInputLine = Color3.fromRGB(252, 209, 215),
	
		Text = Color3.fromRGB(55, 35, 45),
		SubText = Color3.fromRGB(95, 70, 80),
	
		Hover = Color3.fromRGB(240, 210, 220),
		HoverChange = 0.04,
	}
}
